...
### Sistema de vidas actualizado
- El panel para comprar vidas aparece directamente en **Inicio** cuando las vidas llegan a 0.
- En el quiz, cuando no quedan vidas, se bloquean las preguntas y no se inicia el temporizador.
- No se puede pasar a otra pregunta con 0 vidas.
- Se puede comprar 1 vida por 500 monedas o por EXP; el costo de EXP aumenta 100 por cada compra con EXP.
- Si compras una vida desde Inicio o desde la pantalla de vidas agotadas, el quiz puede continuar inmediatamente.
- Si esperas la recuperación automática, al recuperar una vida el quiz se habilita de nuevo automáticamente.
